 ...
 */
final class Version20220214131721 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, donneur_id INT NOT NULL, receveur_id INT NOT NULL, annonce_id INT NOT NULL, validation_donneur TINYINT(1) NOT NULL, validation_receveur TINYINT(1) NOT NULL, note_donneur SMALLINT DEFAULT NULL, note_receveur SMALLINT DEFAULT NULL, INDEX IDX_723705D19789825B (donneur_id), UNIQUE INDEX UNIQ_723705D18805AB2F (annonce_id), INDEX IDX_723705D1B967E626 (receveur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
