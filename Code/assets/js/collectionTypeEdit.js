...
const addFormToCollection = (e) => {
	...
	if(!document.querySelector(".vich") && !document.querySelector("#annonce_photos_" + collectionHolder.dataset.index-1 + "_imageFile_file") && collectionHolder.dataset.index < 3) {
